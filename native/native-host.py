...
def process(link):
    #use selenium to download target doc
    ...
    # driver.get(calendarLink) #uncomment this to actually download
    time.sleep(3)
...
process("https://docs.google.com/document/d/1JivTyrwnIbi8V23sukPgTewOuND-HTYKLVHc8S3BVSc/edit")